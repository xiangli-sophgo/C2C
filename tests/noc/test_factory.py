...
from src.noc.factory import (
    NoCTopologyFactory, TopologyRegistryError, TopologyCreationError,
    TopologyValidator, MeshTopologyValidator, RingTopologyValidator,
    CrossRingTopologyValidator, create_mesh_topology, create_ring_topology,
    create_crossring_topology, auto_select_topology
)
...
class TestNoCTopologyFactory(unittest.TestCase):
    ...
    def test_clone_topology(self):
        ...
        # 克隆拓扑
        cloned_topology = NoCTopologyFactory.clone_topology(
            original_topology, 
            {'num_nodes': 25}
        )
...
class TestConvenienceFunctions(unittest.TestCase):
    ...
    @patch('src.noc.factory.NoCTopologyFactory.create_topology_from_type')
