...
def simple_cdma_test():
    ...
    # 执行基本的receive/send配对
    print("\n执行CDMA_receive...")
    receive_result = chip_A.cdma_receive(dst_addr=0x1000, dst_shape=(1024,), dst_mem_type=MemoryType.GMEM, src_chip_id="chip_B", data_type="float32")
    ...
    print("\n执行CDMA_send...")
    send_result = chip_B.cdma_send(src_addr=0x2000, src_shape=(1024,), dst_chip_id="chip_A", src_mem_type=MemoryType.GMEM, data_type="float32")
