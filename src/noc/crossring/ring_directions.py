...
- TL (Top-Left): 逆时针水平，向上垂直
- TR (Top-Right): 顺时针水平，向上垂直  
- TU (Top-Up): 与TL相同，用于垂直移动
- TD (Top-Down): 与TR相同，用于垂直移动
...
class RingDirection(Enum):
    """环形方向枚举"""
    TL = "TL"  # Top-Left: 逆时针水平，向上垂直
    TR = "TR"  # Top-Right: 顺时针水平，向上垂直
    TU = "TU"  # Top-Up: 与TL相同，用于垂直移动
    TD = "TD"  # Top-Down: 与TR相同，用于垂直移动
...
class RingDirectionMapper:
    ...
    def __init__(self, num_rows: int, num_cols: int):
        ...
        self.logger.info(f"环形方向映射器初始化完成：{num_rows}x{num_cols}网格")
