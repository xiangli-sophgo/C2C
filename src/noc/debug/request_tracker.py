...
class RequestTracker:
    ...
    def __init__(self, network_frequency: int = 1):
        ...
        # 网络状态追踪
        self.network_state: Dict[str, Dict[int, List[Any]]] = {
    ...
    def start_request(self, packet_id: str, source: int, destination: int, 
                     op_type: str, burst_size: int, cycle: int):
        """开始追踪一个新请求"""
    ...
    def track_flit_position(self, packet_id: str, flit_type: FlitType, node_id: int, cycle: int, flit_data: Any = None):
        ...
        # 更新网络状态记录
        self.network_state[flit_type.value][cycle].append({
            "packet_id": packet_id,
            "node_id": node_id,
            "flit_data": flit_data
        })
