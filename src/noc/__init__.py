...
__all__ = [
    ...
    'TrafficPattern', 'NodeType', 'LinkType', 'Priority', 'SimulationState',
    'EventType',
    
    # 数据类
    'NoCMetrics', 'NoCConfiguration', 'LinkMetrics', 'NodeMetrics',
    'TrafficFlow', 'SimulationEvent', 'QoSRequirement', 'FaultModel',
    
    # 类型别名
    'NodeId', 'Position', 'Path', 'AdjacencyMatrix', 'LinkId',
    'Coordinate', 'Coordinate3D', 'ConfigDict', 'MetricsDict',
    'ValidationResult',
    
    # 基础类
    'BaseNoCConfig', 'CrossRingCompatibleConfig', 'BaseNoCTopology',
    'BaseNoCNode', 'NodeState', 'BufferStatus',
    
    # 工厂类
    'NoCTopologyFactory', 'TopologyRegistryError', 'TopologyCreationError',
    'TopologyValidator',
    
    # 便捷函数
    'create_topology', 'create_mesh_topology', 'create_ring_topology',
    'create_crossring_topology', 'auto_select_topology', 'create_config_from_type',
    'get_supported_topologies', 'validate_config', 'list_topologies',
    
    # 常量
    'DEFAULT_FLIT_SIZE', 'DEFAULT_PACKET_SIZE', 'DEFAULT_BUFFER_SIZE',
    'DEFAULT_LINK_BANDWIDTH', 'DEFAULT_CLOCK_FREQUENCY',
]
...
def get_module_info():
    ...
    return {
        ...
        'components': [
            'types', 'base.config', 'base.topology', 'base.node', 'factory'
        ]
    }
