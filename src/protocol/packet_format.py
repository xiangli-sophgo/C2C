...
class CDMAPacket:
    ...
    def __str__(self) -> str:
        """字符串表示"""
        return (f"CDMAPacket(type={self.header.packet_type.value}, "
                f"src={self.header.source_id}, dst={self.header.dest_id}, "
                f"seq={self.header.sequence_number}, size={self.header.total_size})")
...
class PacketFactory:
    ...
    @staticmethod
    def create_data_packet(source_id: str, dest_id: str, sequence_number: int,
                          src_address_info: AddressInfo, dst_address_info: AddressInfo,
                          data: bytes, transaction_id: str = None,
                          reduce_operation: str = "none") -> CDMAPacket:
        """创建数据包"""
        header = PacketHeader(
            source_id=source_id,
            dest_id=dest_id,
    ...
    @staticmethod
    def create_control_packet(source_id: str, dest_id: str, sequence_number: int,
                             control_info: Dict[str, Any], transaction_id: str = None) -> CDMAPacket:
        """创建控制包"""
        header = PacketHeader(
            source_id=source_id,
            dest_id=dest_id,
    ...
    @staticmethod
    def create_sync_packet(source_id: str, dest_id: str, sequence_number: int,
                          sync_info: Dict[str, Any], transaction_id: str = None) -> CDMAPacket:
        """创建同步包"""
        header = PacketHeader(
            source_id=source_id,
            dest_id=dest_id,
    ...
    @staticmethod
    def create_ack_packet(source_id: str, dest_id: str, sequence_number: int,
                         ack_info: Dict[str, Any], transaction_id: str = None) -> CDMAPacket:
        """创建确认包"""
        header = PacketHeader(
            source_id=source_id,
            dest_id=dest_id,
